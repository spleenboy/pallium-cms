...
$('body').on('click', '[data-clone]', function(e) {
    ...
    $clone.find(':input:lt(2)').each(function(i, input) {
...
},{"jquery":29,"jquery-ui/sortable":26}],2:[function(require,module,exports){
(function (global){
...
},{"jQuery":23,"jquery-validation":28,"underscore":30}],3:[function(require,module,exports){
module.exports = function() {
    if (!io) {
...
},{"jQuery":23,"underscore":30}],5:[function(require,module,exports){
(function() {
    require('./markdown')();
    require('./lists')();
    require('./flash')();
...
},{"./widget":27,"jquery":29}],26:[function(require,module,exports){
var jQuery = require('jquery');
require('./core');
require('./mouse');
require('./widget');
...
},{"./core":24,"./mouse":25,"./widget":27,"jquery":29}],27:[function(require,module,exports){
var jQuery = require('jquery');
